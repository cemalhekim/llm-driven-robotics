...
#define NODE_MAIN_LOGGER_NAME "xarm_joystick_input_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libxarm_joystick_input.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<xarm_moveit_servo::JoyToServoPub>";
